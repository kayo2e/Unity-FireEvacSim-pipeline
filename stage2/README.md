...
> 공통 조건: 각 시나리오 30 에피소드 | 커리큘럼 threshold=0.85 / window=50 | BC 없음

| 시나리오 | PPO 3M | PPO 5M | 비고 |
| :---: | :---: | :---: | :--- |
| S1 기본 탈출 | 100.0% ± 0.0% | 100.0% ± 0.0% | 동일 |
| S2 점진적 위협 | 93.3% ± 7.8% | 93.5% ± 8.2% | 사실상 동일 |
| S3 일방 과부하 | 68.4% ± 17.0% | 68.6% ± 18.2% | 사실상 동일 |
| S4 부분 위협 | **72.0%** ± 30.1% | 66.2% ± 30.8% | **5M에서 오히려 하락** |

> **결론**: 5M이 3M 대비 개선 없음 — S4에서 오히려 5.8%p 하락.  
> 3M 이후 과학습(overfitting) 징후로 판단. **권장 학습 스텝: 3,000,000**
